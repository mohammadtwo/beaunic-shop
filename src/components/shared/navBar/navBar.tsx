...
export function NavBar() {
  return (
    <nav className="z-50 fixed top-2 left-[5%]  w-[90%] backdrop-blur-md bg-white/3 border-b border-white/20 shadow-md rounded-2xl p-1 ">
          ...
          <div className="flex-1 ">
            <div className=" flex items-center gap-2">
              ...
              <div className="w-8 h-8">
                <img
                  src="/assets/c8e4e56d-9bf9-4915-b2dd-2700233fd5e2-removebg-preview.png"
                  alt="logo"
                />
              </div>
            </div>
